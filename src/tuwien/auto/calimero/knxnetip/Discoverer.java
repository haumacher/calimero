...
public class Discoverer
{
	...
	private final List<ReceiverLoop> receivers = Collections.synchronizedList(new ArrayList<ReceiverLoop>());
		...
		InterruptedException
	{
		...
		final List<ReceiverLoop> rcv = new ArrayList<ReceiverLoop>();
